...
function initial(){
  ...
  document.getElementById("summation").style.display="none";
  document.getElementById("diag").style.display="none";

  for (n=1;n<=q_sel;n++){
    document.getElementById("select"+n).style.visibility="hidden";
  }
}
...
function start() {
  ...
  document.getElementById("summation").style.display="block";
  document.getElementById("diag").style.display="block";
  for (n=1;n<=3;n++){
  document.getElementById("select"+n).style.visibility="visible";
  }
  quiz();
}
